...
$args = array('cat' => $category->term_id, 'post_type'	=> 'post',          'posts_per_page' =>10, 's' => get_search_query(),
    'paged' => $paged);
    ...
    <div class="row filter row-eq-height">
        ...
        <div class="col col-lg-6 text-right align-self-center ">
            ...
            <div class="search-box">
                ...
                <input type="text" id="search" value="<?= get_query_var( 's' ) ?>" placeholder="<?= __('Search', nowotheme_DOMAIN) ?>"><?= file_get_contents(get_template_directory_uri()."/img/search.svg") ?>
            </div>
        </div>
    </div>
    <div class="row">
