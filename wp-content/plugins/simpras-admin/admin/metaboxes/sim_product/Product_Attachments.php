...
class Product_Attachments{
    ...
    {
        $this->id = 'sim_product_attachments';
        $this->title = __('Product attachments', 'sim');
        $this->context = 'normal';
    ...
    public function meta_box_inner($post)
    {
        ...
        echo '<h1>'.__('Product attachments', 'sim').'</h1><hr>';

        $form = '';

//        $form = apply_filters('file_upload_form', $post_id, '_sim_product_pdf', __('Product pdf', 'sim'));
        $form .= apply_filters('file_upload_form', $post_id, '_sim_security_pdf', __('Product security pdf', 'sim'));
        $form .= apply_filters('file_upload_form', $post_id, '_sim_installation_pdf', __('Product installation instruction', 'sim'));
        $form .= apply_filters('file_upload_form', $post_id, '_sim_certificate_pdf', __('Product certificate', 'sim'));
...
return new Product_Attachments();