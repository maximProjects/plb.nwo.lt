...
class SIM_SpecialOffer extends SIM_Base
{
    ...
    public static $post_type = 'sim_special_offer';

    protected $special_offer_url;
    ...
    {
        $this->save_meta_value('_sim_special_offer_url', $this->special_offer_url);
    }
...
//        $this->set_room_mainColor($this->get_meta_value('_'.self::$post_type.'_main_color'));
    ...
    public function get_special_offer_url()
    {
        return $this->get_meta_value('_sim_special_offer_url', true);
    }
