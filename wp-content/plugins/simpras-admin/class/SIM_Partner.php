...
class SIM_Partner extends SIM_Base
{
    ...
    public static $post_type = 'sim_partner';
    ...
    {
        $this->save_meta_value('_sim_partner_url', $this->partner_url);
    }
...
//        $this->set_room_mainColor($this->get_meta_value('_'.self::$post_type.'_main_color'));
     ...
     * Getting list of class objects
     */
    public static function get_list_by_query($args)
    {
        $default_args = array(
            'post_type' => self::$post_type,
            'posts_per_page' => '-1'
