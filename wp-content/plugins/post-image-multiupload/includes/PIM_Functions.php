...
class PIM_Functions{
    ...
    public function __construct()
    {
        ...
        add_filter('pim_gallery', array( $this, 'pim_pim_gallery'), 0, 2);
    ...
    public function pim_edit_media_custom_field( $form_fields, $post ) {
        $form_fields['declaration_strength'] = array( 'label' => __('Strength', 'pim'), 'input' => 'text', 'value' => get_post_meta( $post->ID, '_declaration_strength', true ) );
    ...
    public function pim_save_media_custom_field( $post, $attachment ) {
        update_post_meta( $post['ID'], '_declaration_strength', $attachment['declaration_strength'] );
        return $post;
    }
    ...
    public function pim_pim_gallery($post_id, $title_image)
    {
        $gallery = apply_filters('pim_gallery_images', $post_id, $title_image);
        ...
        <?php else: ?>
            ...
            <div class="thumbnails nav thumb-slider owl-carousel">
